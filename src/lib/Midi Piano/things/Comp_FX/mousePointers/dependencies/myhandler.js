...
// import _initAnimFrame from "./rAF.js";

var canvWidth,
  canvHeight = 0;

var canvas, c, radius, devicePixelRatio1, container;

var points = [];

export function _initAnimFrame() {
  (function () {
    var lastTime = 0;
...
function positionHandler(e) {
  if (e.type == "mousemove" || e.type == "mouseout") {
    ...
    for (var i = 0, l = Number(e.targetTouches.length); i < l; i++) {
...
function resetCanvas() {
  ...
  /// / / / / / FOLLOWING CODE makes canvas width same as window width (full width)
...
export default function startCanvas(divID, width, height) {
  //   globalThis.canvWidth = width;
  //   globalThis.canvheight = height;
  canvWidth = width;
  canvHeight = height;
